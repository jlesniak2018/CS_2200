...
double compute_emat() {
   ...
   double emat = total_accesses * MEMORY_ACCESS_TIME + tlb_misses * MEMORY_ACCESS_TIME + count_pagefaults * DISK_ACCESS_TIME;
   double emat_average = emat / ((double) total_accesses);
